...
map <Leader>5 :call <SID>startDebugging()<cr>
map <Leader>6 :call <SID>stopDebugging()<cr>
"map <Leader>11> :python debugger_context()<cr>
"map <Leader>12> :python debugger_property()<cr>
"map <Leader>11> :python debugger_watch_input("context_get")<cr>A<cr>
"map <Leader>12> :python debugger_watch_input("property_get", '<cword>')<cr>A<cr>
